...
urlpatterns = [
    ...
    url(r'^module_intro/(?P<journey_slug>[-\w]+)/(?P<module_slug>[-\w]+)/$', ModuleIntroView.as_view(), name='content.module_intro'),
    url(r'^module_home/(?P<journey_slug>[-\w]+)/(?P<module_slug>[-\w]+)/$', ModuleHomeView.as_view(), name='content.module_home'),
    url(r'^module_end/(?P<journey_slug>[-\w]+)/(?P<module_slug>[-\w]+)/$', ModuleEndView.as_view(), name='content.module_end'),
    url(r'^level_intro/(?P<journey_slug>[-\w]+)/(?P<module_slug>[-\w]+)/(?P<pk>[0-9]+)/$', LevelIntroView.as_view(), name='content.level_intro'),
