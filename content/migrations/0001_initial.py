    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attempt', models.PositiveIntegerField(verbose_name=b'Attempt Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('harambee', models.ForeignKey(to='my_auth.Harambee')),
                ('harambee_level_rel', models.ForeignKey(to='content.HarambeeLevelRel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name=b'Slug')),
                ('title', models.CharField(max_length=500, verbose_name=b'Page Title')),
                ('show_menu', models.BooleanField(default=True, verbose_name=b'Show in menus')),
                ('search', models.CharField(max_length=500, verbose_name=b'Search description')),
